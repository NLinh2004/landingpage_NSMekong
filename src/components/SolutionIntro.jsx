  ...
  return (
    <section className="relative py-16 bg-slate-900 overflow-hidden text-center">
      ...
      <div className="absolute top-0 left-0 w-full h-full opacity-30 pointer-events-none">
        ...
        <div className="absolute bottom-[-10%] left-[-10%] w-[500px] h-[500px] bg-blue-500 rounded-full blur-[150px]"></div>
      </div>
        ...
        >
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-3 mb-10">
              ...
              <span className="text-blue-500 font-black text-xs tracking-[0.3em] uppercase">{t('solution_intro.badge')}</span>
              <div className="h-px w-8 bg-blue-500/50"></div>
            </div>

            <h2 className="text-4xl md:text-5xl font-black text-white mb-8 tracking-tighter leading-[1.1]">
              {t('solution_intro.title_1')}<br />
              <span className="bg-gradient-to-r from-emerald-400 via-teal-300 to-emerald-500 bg-clip-text text-transparent">
                {t('solution_intro.title_2')}
              </span>
            </h2>
